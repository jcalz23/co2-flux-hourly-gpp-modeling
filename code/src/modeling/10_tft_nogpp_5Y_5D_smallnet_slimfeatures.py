...
# Define experiment
exp_name = "5YrTrain_5DEncode_SmallNetwork_SlimFeatures_NoGPP"

# Experiment constants
VAL_INDEX  = 3
TEST_INDEX = 4
SUBSET_LEN = 24*365*5 # 5 year
ENCODER_LEN = 24*5   # 5 days
...
early_stop_callback = EarlyStopping(monitor="val_loss", min_delta=1e-4, patience=9, mode="min",
