...
# Define experiment
exp_name = "19_nogpp_14D_small_lr_fullfeatures"
...
training, validation, _ = setup_tsdataset_nogpp_full(train_df, val_df, None, ENCODER_LEN)
...
early_stop_callback = EarlyStopping(monitor="val_loss", min_delta=1e-4, patience=5, mode="min", check_finite=True, verbose=False,)
...
model_dir = "tft_model_19_nogpp_14D_small_lr_fullfeatures_230409_0212"
