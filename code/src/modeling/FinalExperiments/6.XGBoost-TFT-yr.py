...
# Define experiment
exp_name = "5YrTrain_2WkEncode_xgboostv0_slimYr"
...
def setup_tsdataset_treeft_slim(train_df, val_df, test_df, min_encoder_len):
    ...
    training = TimeSeriesDataSet(
      ...
      static_reals=[],
      time_varying_known_categoricals=["year","month", "hour"],
...
exp_fname = "treeft_5YrTrain_2WkEncode_xgboostv0_slimYr_230413_0411"
...
trainer.fit(
    ...
    ckpt_path =  exp_model_dir + os.sep + "epoch=1-step=19946.ckpt"
)
