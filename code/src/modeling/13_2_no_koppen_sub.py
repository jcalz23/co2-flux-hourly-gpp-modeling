...
# Define experiment
exp_name = "13_2_no_koppensub_2Y_3D"
...
def setup_tsdataset_nokoppensub(train_df, val_df, test_df, min_encoder_len):
...
training, validation, _ = setup_tsdataset_nokoppensub(train_df, val_df, None, ENCODER_LEN)
