...
# Define experiment
exp_name = "17_tft_nogpp_7D_64HS_small_lr"
...
early_stop_callback = EarlyStopping(monitor="val_loss", min_delta=1e-4, patience=4, mode="min", check_finite=True, verbose=False,)
